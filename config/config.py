...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/iamvillain77/Extra-Plugin",
)
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "@odsmusichub"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Iamvillain77/VillianMusic",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/odsmusichub"
)  # Example:- https://t.me/VIP_CREATORS
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/oldskoolgc"
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://unitedcamps.in/Images/file_4094.jpg",
)
